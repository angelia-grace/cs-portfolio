...
fun TreasureFoundScreen(
    ...
    Surface(
        ...
        Column() {
            TreasureDetails(cityUiState = cityUiState)
            HomeButton(cityUiState = cityUiState, onQuit = onQuit)
        }
    }
}
...
fun TreasureDetails (
    ...
    Column(
        ...
        Text(
            text = "Treasure Found! Congratulations!",
            fontSize = 36.sp,
            fontWeight = FontWeight.Bold
        )
        Text(
            text = "Information about treasure location",
            fontSize = 20.sp
        )
